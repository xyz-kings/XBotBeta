...
module.exports = {
  command: ["ceklucky"],
  category: "fun",
  description: "Cek keberuntungan seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.FunBaseURL}/xyz/ceklucky/user`,
      ...
      console.error("[CEKLUCKY ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
