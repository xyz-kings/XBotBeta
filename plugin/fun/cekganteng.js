...
module.exports = {
  command: ["cekganteng"],
  category: "fun",
  description: "Cek tingkat kegantengan seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.FunBaseURL}/xyz/cekganteng/user`,
      ...
      console.error("[CEKGANTENG ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
