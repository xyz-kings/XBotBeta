...
module.exports = {
  command: ["seberapajones"],
  category: "fun",
  description: "Cek level jones seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.Funv3BaseURL}/xyz/seberapajones/user`,
      ...
      console.error("[SEBERAPAJONES ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
        { text: "❌ Terjadi kesalahan saat cek level jones." },
        { quoted: m }
      );
    }
  },
