...
module.exports = {
  command: ["tarot"],
  category: "fun",
  description: "Ramalan kartu tarot",
  ...
  async execute(bot, m, args) {
    try {
      ...
      await bot.sendMessage(
        m.key.remoteJid,
        { text: "❌ Terjadi kesalahan saat menarik kartu tarot." },
        { quoted: m }
      );
    }
  },
