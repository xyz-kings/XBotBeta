...
module.exports = {
  command: ["seberapapintar"],
  category: "fun",
  description: "Cek tingkat kepintaran seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.Funv3BaseURL}/xyz/seberapapintar/user`,
      ...
      console.error("[SEBERAPAPINTAR ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
        { text: "❌ Terjadi kesalahan saat cek tingkat kepintaran." },
        { quoted: m }
      );
    }
  },
