...
module.exports = {
  command: ["seberapaberuntung"],
  category: "fun",
  description: "Cek tingkat keberuntungan seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.Funv3BaseURL}/xyz/seberapaberuntung/user`,
      ...
      console.error("[SEBERAPABERUNTUNG ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
        { text: "❌ Terjadi kesalahan saat cek tingkat keberuntungan." },
        { quoted: m }
      );
    }
  },
