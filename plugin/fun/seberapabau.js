...
module.exports = {
  command: ["seberapabau"],
  category: "fun",
  description: "Cek seberapa bau seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.Funv3BaseURL}/xyz/seberapabau/user`,
      ...
      console.error("[SEBERAPABAU ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
        { text: "❌ Terjadi kesalahan saat cek level bau." },
        { quoted: m }
      );
    }
  },
