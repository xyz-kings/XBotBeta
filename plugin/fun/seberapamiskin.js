...
module.exports = {
  command: ["seberapamiskin"],
  category: "fun",
  description: "Cek tingkat kemiskinan seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.Funv3BaseURL}/xyz/seberapamiskin/user`,
      ...
      console.error("[SEBERAPAMISKIN ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
        { text: "❌ Terjadi kesalahan saat cek tingkat kemiskinan." },
        { quoted: m }
      );
    }
  },
