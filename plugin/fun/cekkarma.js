...
module.exports = {
  command: ["cekkarma"],
  category: "fun",
  description: "Cek karma seseorang",
  ...
  async execute(bot, m, args) {
    try {
      ...
      const res = await axios.get(
        `${config.FunBaseURL}/xyz/cekkarma/user`,
      ...
      console.error("[CEKKARMA ERROR]", err);
      await bot.sendMessage(
        m.key.remoteJid,
